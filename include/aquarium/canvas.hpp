...
struct CanvasCacheStats {std::size_t textureLoads{},textRasterizations{};bool operator==(const CanvasCacheStats&)const=default;};
class Canvas {
 public:
 ...
 CanvasCacheStats cacheStats()const{return {textures_.size(),textRasterizations_};}
 ...
 void roundedImage(std::string_view,Rect,float radius,float feather=0);
