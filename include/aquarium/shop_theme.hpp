...
enum class Surface {Tab,SelectedTab,Positive,Button,Well,Card,LockedCard,Close,FishCard,LockedFishCard,FastBadge,Buy,PearlBuy,LockedPrice,Keep,DisabledButton,PausedBadge};
