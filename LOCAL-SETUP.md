...
This is a separate local Git project created from `aquarium-native-source.zip`. No remote is configured.
...
## Setup completed on 9 September 2026
...
even gaps, and Medicine is hidden for now. Help in Settings can start the guide.
...
The existing domain suite still has its documented feeding-order fixture failure.
