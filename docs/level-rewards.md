...
The level checkpoint, ledger entries and wallet changes commit with the fish settlement. Retrying the settlement or reopening its saved result cannot pay those levels again. The level-up dialog displays already credited grants; dismissing it has no economic effect.
