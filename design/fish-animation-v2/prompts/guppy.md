...
Character: GUPPY, the RIGHT fish in the reference. Faces LEFT. Use the largest version from the sheet. Huge cream near eye under a heavy lavender half-closed lid, tiny black pupil looking forward, smaller far eye peeking to the left, sleepy unimpressed expression. Blue/turquoise back, pale yellow saggy cheek and belly, broad orange tail with simple yellow bands, low triangular orange dorsal, orange side fin, tiny blue lower fin. Mouth is the small round pink pout close to the blunt front of the face. Closed lids are lavender. The detached tail's narrow root points LEFT; fan spreads RIGHT. Keep tail ONE smooth membrane, no feathers or separate lobes. Preserve the exact huge-eyed face and compact head/body from the reference; no neck or bird profile.
